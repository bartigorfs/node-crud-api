  ...
  switch (message.type) {
    ...
    case 'getUserById': {
      try {
        ...
        else worker.postMessage({ type: 'getUserByIdResponse', error })
      }
      break
    }
    ...
    case 'addUser': {
      try {
        ...
        else worker.postMessage({ type: 'addUserResponse', error })
      }
      break
    }
    ...
    case 'deleteUserById': {
      try {
        ...
        else worker.postMessage({ type: 'deleteUserByIdResponse', error })
      }
      break
    }
    ...
    case 'updateUserById': {
      try {
        ...
        else worker.postMessage({ type: 'updateUserByIdResponse', error })
      }
      break
    }
  }
